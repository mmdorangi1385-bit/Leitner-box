...
const CACHE_NAME = 'leitner-cache-v54';
const ASSETS = ['./', './index.html', './manifest.json', './icon-192.png', './icon-512.png', './icon-hero.png', './icon-header.png', './icon-badge.png', './favicon.ico', './favicon-16.png', './favicon-32.png', './apple-touch-icon.png', './words_a1.json', './words_a2.json', './words_b1.json', './marketplace.js', './marketplace.css'];
